/*
	...
	Changelog:
	v1.3 by zwische
		- public method: clearTooltip
		- integrated CSS in own layout
...
if(typeof Bnet.D3.Tooltips == 'undefined') Bnet.D3.Tooltips = new function() { // Reminder: Keep in sync with the equivalent code in d3.js
	...
	*/
	...
	//var URL_PATTERN_BASE = 'http://localhost/d3maxstats/(.+)';
	var URL_PATTERN_BASE = base_url+'(.+)';
	...
	*/
	...
	function initialize() {
		//setTimeout(getCss, 1); integrated CSS in own layout
	...
	function getCss() {
		...
		//var cssUrl = 'http://localhost/d3maxstats/layout/layout.css';
	...
	function parseUrl(link, params) {
		...
		for(var i = 0; i < URL_PATTERNS.length; ++i) {
			...
			switch (folder) {
				case 'barb': folder = 'barbarian'; break;
				case 'crus': folder = 'crusader'; break;
				case 'dh': folder = 'demon-hunter'; break;
				case 'wd': folder = 'witch-doctor'; break;
				case 'wiz': folder = 'wizard'; break;
			}
